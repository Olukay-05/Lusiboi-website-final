      ...
      >
        <div className=" flex items-start justify-between p-4 flex-col sm:items-center md:items-center lg:text-center lg:items-center xl:items-start gap-6 lg:gap-10 pb-8 md:px-20 lg:px-0 md:text-center xl:gap-12">
          <h1
            ...
            className=" text-[#a86a33] border border-yellow-50 border-opacity-0 dark:border-[#a79381] dark:border-opacity-0 opacity-0 transform translate-y-[100px] font-libre-baskerville lg:text-center xl:text-left text-3xl sm:text-4xl md:text-5xl lg:text-6xl max-w-4xl md:max-w-4xl leading-tight md:leading-tight lg:leading-tight font-semibold xl:max-w-[38rem]"
          >
